...
const BannerSection = ({banner}) => {
    return (
        ...
        <div className='grid grid-cols-1 lg:gap-10 md:gap-8 gap-5 md:grid-cols-1 lg:grid-cols-2 lg:mt-14 mt-5 lg:mb-10 relative rounded-xl w-11/12 mx-auto'>

           
             <div className='relative md:aspect-[16/7] aspect-[16/7]'>
             {
            ...
            quality={100}
            loading="lazy"
            className='cursor-pointer shadow-md rounded-lg h-full w-full border'
            ...
            fill={true}
            style={{objectFit: 'cover'}}
            className='cursor-pointer rounded-md h-full w-full border'
            quality={100}
            /> :
